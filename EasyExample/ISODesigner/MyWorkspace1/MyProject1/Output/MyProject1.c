...
const unsigned char ISO_OP_MEMORY_CLASS isoOP_MyProject1[] = {
	...
	ID(DataMask_Home), TYPEID_DATAMASK, COLOR(230), ID(SoftKeyMask_Home), 15, 0, 
		XYREF(Button_minus, 169, 424),
		XYREF(Button_PlusPlus, 310, 380),
		XYREF(Container_Gesamtzaehler, 10, 10),
		XYREF(Container_Tageszaehler, 10, 98),
		XYREF(Meter_Gesamtzaehler, 10, 293),
		XYREF(Meter_Tageszaehler, 10, 293),
		XYREF(LinearBargraph_Gesamtzaehler, 229, 188),
		XYREF(LinearBargraph_Tageszaehler, 298, 190),
		XYREF(InputNumber_Gesamtzaehler, 8, 440),
		XYREF(Button_Seite1, 75, 190),
		XYREF(InputNumber_Gesamtziel, 148, 265),
		XYREF(InputNumber_Tagesziel, 386, 220),
		XYREF(OutputString_11010, 293, 165),
		XYREF(OutputString_11011, 120, 162),
		XYREF(Container_Tagesziel, 16, 19),
	ID(DataMask_Seite1), TYPEID_DATAMASK, COLOR(118), ID(ID_NULL), 1, 0, 
		XYREF(Button_Home, 283, 278),
	...
	ID(Container_Tagesziel), TYPEID_CONTAINER, WORD(282), WORD(219), 1, 3, 0, 
		XYREF(Ellipse_15000, 0, -1),
		XYREF(OutputString_11012, 81, 35),
		XYREF(OutputString_11013, 6, 92),
	...
	ID(SoftKey_minus), TYPEID_SOFTKEY, COLOR(197), 1, 1, 0, 
		XYREF(OutputString_11007, 19, 21),
	...
	ID(Button_minus), TYPEID_BUTTON, WORD(126), WORD(44), 12, 12, 1, 0, 1, 0, 
		XYREF(OutputString_11006, 20, 1),
	ID(Button_Home), TYPEID_BUTTON, WORD(143), WORD(64), 9, 9, 1, 0, 1, 1, 
		XYREF(OutputString_11008, -4, 14),
		MACRO(EV_KEYRELEASE, Macro_1),
	ID(Button_Seite1), TYPEID_BUTTON, WORD(134), WORD(54), 249, 249, 1, 0, 1, 1, 
		XYREF(OutputString_11009, -4, 9),
	...
	ID(InputNumber_Gesamtziel), TYPEID_INNUM, WORD(64), WORD(34), COLOR(221), ID(FontAttributes_Default), 0, 
		ID(NumberVariable_Gesamtziel), LONG(123UL), LONG(0UL), LONG(65535UL), LONG(0L), FLOAT_1, 0, 0, 2, 1, 0, 
	ID(InputNumber_Tagesziel), TYPEID_INNUM, WORD(64), WORD(33), COLOR(220), ID(FontAttributes_Default), 0, 
	...
	ID(OutputString_Reset_Tageszaehler), TYPEID_OUTSTR, WORD(80), WORD(40), COLOR_WHITE, ID(FontAttributes_Button), 3,
		...
		'T', 'a', 'g', 'e', 's', 0,
	ID(OutputString_11006), TYPEID_OUTSTR, WORD(80), WORD(44), COLOR_WHITE, ID(FontAttributes_Default), 1,
		ID(ID_NULL), 1, WORD(4), '-', ' ', '-', ' ', 0,
	ID(OutputString_11007), TYPEID_OUTSTR, WORD(53), WORD(34), COLOR_RED, ID(FontAttributes_Default), 0,
		ID(ID_NULL), 0, WORD(4), '-', ' ', '-', ' ', 0,
	ID(OutputString_11008), TYPEID_OUTSTR, WORD(143), WORD(29), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 1, WORD(4), 'H', 'o', 'm', 'e', 0,
	ID(OutputString_11009), TYPEID_OUTSTR, WORD(134), WORD(29), COLOR_WHITE, ID(FontAttributes_23000), 1,
		ID(ID_NULL), 1, WORD(6), 'S', 'e', 'i', 't', 'e', '1', 0,
	ID(OutputString_11010), TYPEID_OUTSTR, WORD(159), WORD(20), COLOR_WHITE, ID(FontAttributes_Default), 0,
		ID(ID_NULL), 0, WORD(11), 'T', 'a', 'g', 'e', 's', 'z', 'ä', 'h', 'l', 'e', 'r', 0,
	ID(OutputString_11011), TYPEID_OUTSTR, WORD(166), WORD(20), COLOR_WHITE, ID(FontAttributes_Default), 0,
		ID(ID_NULL), 0, WORD(12), 'G', 'e', 's', 'a', 'm', 't', 'z', 'ä', 'h', 'l', 'e', 'r', 0,
	ID(OutputString_11012), TYPEID_OUTSTR, WORD(102), WORD(41), COLOR(166), ID(FontAttributes_Default), 0,
		ID(ID_NULL), 0, WORD(6), 'f', 'e', 'r', 't', 'i', 'g', 0,
	ID(OutputString_11013), TYPEID_OUTSTR, WORD(268), WORD(32), COLOR(220), ID(FontAttributes_Default), 0,
		ID(ID_NULL), 0, WORD(18), 'F', 'e', 'i', 'e', 'r', 'a', 'b', 'e', 'n', 'd', ' ', 'm', 'a', 'c', 'h', 'e', 'n', ' ', 0,
	...
	ID(Ellipse_15000), TYPEID_OUTELLIPSE, ID(LineAttributes_24000), 
		WORD(281), WORD(215), 0, 0, 0, ID(FillAttributes_25000), 0, 
	ID(Meter_Gesamtzaehler), TYPEID_OUTMETER, WORD(167), COLOR_BLACK, COLOR_BLACK, COLOR_BLACK, 13, 11, 165, 105, 
		WORD(0), WORD(100), ID(NumberVariable_Gesamtzaehler), WORD(0), 0, 
	ID(Meter_Tageszaehler), TYPEID_OUTMETER, WORD(167), COLOR_BLACK, COLOR_BLACK, COLOR_BLACK, 13, 11, 165, 105, 
	...
	ID(FontAttributes_23003), TYPEID_FONTATTR, COLOR_BLACK, 5, 0, 128, 0, 
	ID(LineAttributes_24000), TYPEID_LINEATTR, COLOR(198), 4, WORD(65535), 0, 
	ID(FillAttributes_25000), TYPEID_FILLATTR, 2, COLOR(48), ID(ID_NULL), 0, 
